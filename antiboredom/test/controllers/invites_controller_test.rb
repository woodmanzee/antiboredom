...
class InvitesControllerTest < ActionController::TestCase
  ...
  test "should create invite" do
    assert_difference('Invite.count') do
      post :create, invite: { activityid: @invite.activityid, attending: @invite.attending, userid: @invite.userid }
    end
  ...
  test "should update invite" do
    patch :update, id: @invite, invite: { activityid: @invite.activityid, attending: @invite.attending, userid: @invite.userid }
    assert_redirected_to invite_path(assigns(:invite))
  end
